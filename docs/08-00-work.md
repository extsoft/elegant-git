...
protected default. On a protected branch it still asks which branch to take. And `amend` is never
detected and never offered; rewriting your last commit is always something you ask for explicitly
with `eg work amend`.
